...
// PCF8574 I2C Mode
DriverL298 motor(0x20, 2, 15, P0, P1, P2, P3);
...
void loop() {
  if (millis() > motorTick) {
    motorTick = millis() + 33;
    motor.setMotorSpeeds(pidController.getLeftOutput(), pidController.getRightOutput());
  }
  if (millis() > debugTick) {
    ...
    Serial.print((pidController.getPrevInput(0)) / (3950 * 0.033) * 60);
